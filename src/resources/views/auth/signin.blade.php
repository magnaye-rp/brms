...
@section('title', 'Welcome Back - Sign In')
...
<form method="POST" action="{{ route('login.post') }}">
    ...
    <a href="{{ route('password.request') }}" class="d-block text-end mt-2 mb-3" style="color: #2196f3; font-size: 14px; text-decoration: none;">Forgot password?</a>
    
    <button type="submit" class="btn-primary-custom" style="background: #2196f3; color: white;">Sign In</button>
</form>
...
<p class="text-center-link" style="font-size: 12px; color: #999;">
